...
for (i in 1:length(topo_folders)) {
  # import land surface elevation (topo) and maximum rooting depth (mrd)
  ...
  # convert maximum rooting depth to an elevation
  mrd_elev = topo_in - mrd_in # max root depth elevation by subtracting root depth from DEM
