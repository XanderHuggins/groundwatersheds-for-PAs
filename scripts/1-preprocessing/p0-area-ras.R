# Name: p0-area-ras.R
# Description: Generates a grid cell area raster globally at 30 arc-second following:
# Santini et al. 2010 https://doi.org/10.1111/j.1467-9671.2010.01200.x

library(here)
invisible(sapply(paste0(here("scripts/setup"), "/", list.files(here("scripts/setup"))), source)) 

# set 30 arcsecond resolution
RES = 0.5/60
